"""A modified version of a file from @timrae
License: GPLv2
source: https://github.com/timrae/pylase/winspec.py
changes: Commented out large portions of the controller functionality, as these
only work on a Windows machine connected to a Princeton Instruments
spectrometer. Analysis by Mac and Linux users only need this file for opening
existing .spe files.
"""
